...
// user configuration
const config = {
    address: "config", // the value to put after "about:" — if this is "cfg" then the final URl will be "about:cfg". if you use this and my appMenuAboutConfigButton.uc.js script, and you want to change this address for whatever reason, be sure to edit the urlOverride setting in that script so it says "about:your-new-address"
